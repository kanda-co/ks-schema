...
export declare const isArrayOfValue: <Entity>(
  data: Entity | Entity[],
) => data is Entity[];
export declare const createAsyncThunkAction: <
  Entity extends void | StringIndexedObject<any>,
  Args extends StringIndexedObject<any> = undefined,
>(
 ...
 */
export declare const createResponseHandler: <
 ...
 */
export declare const createVoidResponseHandler: <
  State extends GeneratedState<unknown>,
>() => (
  state: State,
...
export declare const generateSelectors: <
  Entity,

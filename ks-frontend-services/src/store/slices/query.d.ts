...
export declare const querySlice: import('@reduxjs/toolkit').Slice<
  QueryState,
  {
    setFlags: (
      state: import('immer/dist/internal').WritableDraft<QueryState>,
    ...
    setQuery: (
      state: import('immer/dist/internal').WritableDraft<QueryState>,
      action: PayloadAction<[QueryType, string]>,
    ) => {
      queryTerms: {
        payments?: string;
        home?: string;
  ...
  'query'
>;
export declare const setFlags: import('@reduxjs/toolkit').ActionCreatorWithOptionalPayload<
    [
      QueryType,
      (
        | {
    ...
    'query/setFlags'
  >,
  setQuery: import('@reduxjs/toolkit').ActionCreatorWithOptionalPayload<
    [QueryType, string],
    'query/setQuery'
  >;

...
import type { AuthUser, Company, Credit, Document, Event, InfoAuth, InfoCompany, InfoEntity, InfoGhost, InfoIP, InfoQuery, Job, Monitor, Payment, Rate, Subscription } from '../../generated/components/schemas';
export declare const getSelectors: () => {
    ...
    infoEntity: import("../types").Selectors<InfoEntity, StringIndexedObject<GeneratedState<InfoEntity>>>;

...
var swaggerSpec = []string{
	...
	"24Js/DPypady8UumlDxcFLpc0/1n3k/c9HadzMgf4X63S2rpxtRfN2V5eHwMRK4XPRzMzU0ySK6BHQcv",
	"jAeVLWjxXsSQ6LUeE0Ji1j7HABJHFkdcvbwRNUU3eqArP4PgodgRf/5HuuwbhMpGjjjemF/giEVZj9Dh",
	"Jp4aNWKHG9ZJdeaBp2eCJ4ndDxmZHcl7ESNJyi9HxPWHR94wWGR2pA1jRQbomowUmQddH/XQaGI4m8XB",
	"0cya2eKIm3J8nOv8lkPhIeXhQxUxMOa8TxCdsvBE2sMFVZr236ifP1TaA276tDclrdeciC0p3N3MrCwG",
	"XXt7APAW7GUsAMjkoJLYZq+T4e3QEEu5jFpxlvqb+vlDZSlTB2rG0gQgPFWaCPMeOk75V3RTvbcqTZBl",
	"Lubjdfnc1C7UWGbr3hZtpck8tJ41kfkWQG5qSMqSBnhOl5l0U6UhnSLxcJ6TWpJiWOwVXlrBlHH2rUfR",
	"p+5N87NfTPWnzZJBrEfN326Wym6Rw161b/0QqAe47hqQJc5NVIQwPI6wGIPMeNcKj1dm51/zEBche3d7",
	"T/SyeRwxeLq5aJ4np9gMkb7na5sjA3S9bcN8sBwV6h8mqQO/2xzJHHjexmic8r7NiMaPfLw0cezN5Ihp",
	"Zs58KfQNHDRtfeghTfK5a/U+6JLtao7RJomHgxnqkyQgkaW4t9RhndJr+DDb3kf6gF5JunA8zrYfh87o",
	"liTgnTlGpoOFKRmKozTKGH1hMFHvDLhm8Kjq1qF/SgrJMHP0tM/5s4hkqKuOjjPJcsLp8OFyQaCYzpMD",
	"AtV0Cr1T6unM6P3oZ1WTwuNszqtm9syYRuIxJ9T5iuMq305TXb+GtkQ8dSGVhHbVLvAUPdgmbYwOOEVL",
	"jtCzHWL+gjBY7un686zY7D6CwyMYOiVM/D65LYxBjo/xkEHjM0VJXAud5R6cQsHhk8Alak7vyf3DXZLo",
	"sZOsCdmDdQmDx9UL9sPXIxprs+MDQNfqgDwjxaf/PvRZ0WrNzrHJohlVUi+qNYM0mw9DfDd8QvdSsOlH",
	"fvbp5RLBK1dBN9UZrdAOb2gOhTMf/THYNLjhpTixqZnnpDQeh1vLQm7lHS7Kcb4lQ34O1dFEskPThwyF",
	"gAkGPAwALKx9hhdbHnAh2vWykv4D1eQ7It8ddpXmOk/MKj11AlqTEvCy8dD6AKHUKYyqbdrC7RXIfMSw",
	"ommwzU24jVI7FF5bkl+zRp7ZlEqD5+E3prVN/vWAZ2Nvqgg2zNw2bZfpoevPu/rVpn4RllhXN7OtXA6p",
	"dcluHv0I/Z5scH4YWhzcGd19YTPizlPI1aWSz9AOe12eLjHdneE8t7UI0/ysWj4zDd+NngfAIgNsqJQA",
	"AkpgFMjDY5SUIM3JTLVAWBUpwnW1CmF3ZbOTofdIlFH1cSQtvp99YcQdBKkwbNk0xNbuZbWp2xHLl2HL",
	"h5kmLW5H03KQtzhvk93pql0ISq2NTeVqxk6fjFZ52RTES96jkPdVYibXKjZJW3bnUSIFguwZ05ygLr3K",
	"zNQLzV8+dHpPUymQj/JA6+g94Ndc717xp4Xzu3n4DcsyAdWQoU02vEK4QqSkG7qiJZW2NiT66NnF5ccz",
	"euG3m59KejQ60c2W5ltI97YiSsSCWrCmFa5yUqA3bDUU066ZqxGS7XT5sLRMtY2OFaolY4KUBy3qlEnd",
	"DhSTRb8MCrrHSSNhIZwqf0z7uQogHzwtgYAmyGI+kD927R0eCXIApkTQt22yzkEe0TaqzSTESc245vam",
	"WiKDPPM3wmWZzIGq+i3iOU/VTxne6dRW+o9iT7ggUFwRe5/L0q9ENADa4tEuw10BuphnKshoZpCkM48i",
	"k7H0USXsjzcV4S81KRL7w4FsEqTOTHv9A6CwQ/POtnCc3dkWE2I5Vfc7hm90c7bBL8eont27nvTYqzuM",
	"fW5HF82qYDtMU9mL/d/vtIycFSlFXbfITIt3fKIcH/4Ku3u+QU1d8MLdEr09tPuFysGaZqa/ajWyVTjR",
	"BWfTzHzfKbrNfNe0Ss1ofhrPyt1moXSPbrWqxqqgROBBB48v33GCUEORlAKk9VVQLTgpyR7DVaxGl5h7",
	"1C7EpsD6kivosbdCRpe13+JdXZIzRcYhJem5bvdXoPaDEU0NnwxTAwCUaTBP88cHMLSBAshRwfFahvaP",
	"JHDnvmbcNV6X7KbVgc3NiMutXXNytqZl6VJ1+zm0FTRLeA8NFStdZ8z7He10BZY4eEesKNFhlc3WBFAk",
	"meQ7aPFwLlY9fsqcB/jQjhXEw79GIZLsmjx+PtUJ8JJiEOK5Mfkoju3D9T2mJeSXlwz9ZzRYo0VQh8+2",
	"BJdyO6iZ/kU3ecj4mBSW1MmhawsjDehM7ecAxg7aDfo6eKf1IM4vLhcPvF0uLtOFH/Sl0sXl/guEi4IT",
	"IeaH8hiUiHG0xmW5wvk1ZB8mfE84AmT6JLm47JKjJLgYlLbfqwYPVSQPSqDoAu6RrEP6Z+B8vtPXITqq",
	"UegKEHKLnl1cqgNt9/jXViPAgxxTyNXnbWudQXn9AGy9HNbI2cnhJPzAYurob2SPBD6/AfP0OG6D88O0",
	"IIHO1fbDnfnjd+in3Dibu733LTwguqwPMDjAM0eHjrQffav1QUntzTTkOoEQj4ZzJXbsDVy7FqVCbQj6",
	"A6qYnJeBejzwIR099HQoadLin604rkbpeakbf23bHp1y/zhPzGO7M7rLG+IkuzaHtzm64npAhlxh1ttn",
	"CSFuGB9Wji5to3cT8GNhjAYgux85EUT+HuN9+iXIyWgei9fRgmCIwf5mRMVDcZceP6W/aoPDdzPh8iBp",
	"Lh6dhcbhpKSIQjq38yuJ0+N8GhohHX7iWA7ftb3E8kGj2mH8lIbpFmYCMJACV1dOe3Z5McdqWU6RnAh6",
	"SyJARIc6gghharsl9/sr0+bhdrydYdTEMeBqh5suD6Z1ZnNt+LgCYBxsUkwCfLZ2SgdsxpWpjWjlDJgJ",
	"Bwp46M/cDAOS4LVq+co0HNFgYVRkRn0SemywuoQ8ClcF2ofVEHU1UbZhCEuJ8y0p5ucGPA78lnUC1HTY",
	"B4obY0nOtBo2xD9/N02fmxp5gwxkx0VyS4XZjHcrvGeyeLVNQ+5aLt6ebdiZ+ahhfHjLyeCEssrOGM9L",
	"ALHfe9d4dq59Ry4NaeT9T7vSHgsRTtfDOu3fdZN3YzJp+KKa/FN4DOGDP1+D6SQkD5xtJmwgFRbzV7Z6",
	"H/IAQljC9ASAb9SqZ5j5742mRnjFP5SrxEZ73L8wSAV62FR0b9zMj7O7B+Ax+fzeaB6YXZroMFQ+DNt4",
	"w1bnuCzPa3xgjRwqWKobaHoPKgwM/oFLHeZyqIl2+5YEq+MdPHo0b0rMkZ00rki8YasM9lMszExIZV2D",
	"806wEnMIdX4XEZCvcVke/JQrEpclPT7Pkdp5+lSwZqqQWDZQtQRSMGJazDgHoKkQD0LEkBXI/oatYoUK",
	"VGNaEN5WlhdYgt8f9F/FOWb5VCiEUChSo37Sf8MbkIFoJMXW09JOTmBoiMp6aikGE+Kql2FyZkKrm0sy",
	"JruWQ8rEh0TMrgCZbWK0OBVTOSHfORUfT5lpekh69wpNM1+miuBrWP5Pqgr4HvKbfe32IyxAxFCtlqSL",
	"7mmFTWkapUb96uA/ZnznHNkVc1pNUpqtfUYwp5p1NiBbK0V+TUMHukO0wXxMQwpVIEEqOUHdOTfq1CDD",
	"qwZ/ZatXWP7AJPmQz0tDDbqpjHLptFH9A5ZUrHEO7g6lmz4B/dssRk2kFb12md3VxLjOaeGK51q83Js+",
	"fo55vqWDDKobfGCanEHLfPVyA+CRp++UuqzvMaV1VoJXMnGx3qvMqtbpl/CbcS3WLqipI+xI8WCvS7+n",
	"1QDfKNT6Dd9H9rFxqz+9/F5MOss2pFI4UsI/CJoF4T+32/P4c0W9AIQ1dyVWMc5DOqADgvsHWchr974K",
	"IG+JU3horgmHus6EENBJHGF9gImTyLT4wNSOVk102LUlY+emgFhQ45COW1DRUrgJfmF7wjktBvjlR9Pi",
	"/XRV2dWl3AYWPzZPvZpLR3AappmHYfckL1IcbrHPwMrSkpxuNoQr2bcT/mO6j+gaGbhXJfl4QBWzlFoz",
	"7rDT/rP4ZMrmqPFh8JbwPdwSl9rNpJ1pqU1hfFHGp7P43U823U9W49BLtkSj4nxFDqwqJvvF9JXk2O32",
	"B3599D5cP5vL5zncPZ//0rAhnfNv6uf3UFp+T3DxTPeO1w9RCwLc2FOrki4DCTxYbjNC/n79cHR8scKr",
	"ySNjt7JC6pbtCLuptMAFe6rF8v3dP3AycuH2Ujd4omyPq8OP62SAYvLybfnr7VWElIBng7GWsciulgfE",
	"Vm9ILnU2n5rVTYml0vZyVhWYH1BJKiXB4CWLTuSjX7B56qIhfmY+cYKLA3BCTfNrxcruBDa3UP8figPU",
	"beeur5ao5mRPWSOsK9DDXi8hUc5qpXoq/VaxILzu1r10baN/zUxn8pDNcDV3FcpSLXbZqNaBSlqRsftG",
	"z0JQHFRzCu8TrBipmHRn5jRhIEhVDMkC9fuclK75PC6CeOvjLluGkf1qZqh+hL0NxvFcL9ROITDdVPbW",
	"Pk1nuqn07T5599f7969c2vXHnJmeOFSomnQJPp8zx1y3zzro4CQUj2uXdzGymmo0pOAn2+QDk38ONb57",
	"v9SKoPtlZmLRwTwC8ihf7Cm5GRWWf6fk5vdQqHbvKqQ9JRmk4H13Msim30tFo39PcPHAb9vGG73NwFWW",
	"rcB/N7l5flxzclxzqZo/yvMcSGJ3xMO8Emj2BBI7t8C27Gky9g291zMZITssCQJtS3ABAb9GpPmcs0yW",
	"r9bw6TYdKWceROkWElpEcpEPzp1PmDt/oLnJhLnJA80tJ8wtT5z7Xbl93XvEss1K+jiOXS0EBt9ulkZO",
	"zO7xpk7jydmudZb3d7x/Ik189xYXBCGMMPeDaDwf8rl1Cqf2nu3NjV9jx1T3LZ/Z973Takh/+p1FnwqL",
	"BhbF3NgzCCBM8WHqPeLvfHgnPnwYVWP06eJ8tIxGPi25HUPjmMJxbuMrz96wlZ/ELPHKx7T+K1uZdFa/",
	"b7LZ29EtsaZY1Davpx+m61KeQZgCRIzObUPoBG1TgJ6wKXJWVSSXZ7r4zlD4ObSD9G7i953wDo4btwlS",
	"Njdg3NCTsqp9gZA2wntd4q6AZHvJTNWmCblkbLdqg7C2GV1vtDoguSWUGwDu90ScliQnSOk4eTWkCJdi",
	"diKdV2b7AdRPkRFQPnhUQrxQrX6XD7NUR4Esf6alJFH2AQKnNqbOp7nWnZ/E3lR2nlvSjLdlBO1eeu7J",
	"23NKEO/vO3KGBiJQZsDrG1g4Wrebk1M6Bt7c/NNxFI5uKU7WuiZ/KixwTfjvW+odbKmaK0pIqpldwRpX",
	"g4GAHJeTleC2Q0IFbgn1M8x7lRrAHp7tKDpS+j3Y6HqNRuedvY8o2P8h6BNEgCBV4QoKJ+NVjdPhdznw",
	"VO4AIOIWyGFKHLtXJ3Pi505RRMZR5zVZzqo94dLTHCFZmn5vWATrWiIqES4FQ4JIoduboCIrqrLo0/Pk",
	"1tDiLbkvQF3//XScocIJlJl8DtlT7HeF82SF0ykCk7bUGSzpTD9gweXIDgPr4Zlp+/t2m+MhlIhstV5U",
	"JcGNAx/q6c+JmclbSXil1Fnwn/T0qXYLIsuv4MUdZvhdun7YiwetHPaskdufBEkWQ9+RWWYUsmC1CHUL",
	"GQ6ifEGOjuq1u6LmTAJUD3YUXVRr9iJ5DtlF2+eZj3oCDfGJOYVmyCo+2pK8kggdeUEWj07lZsZEbmYp",
	"DHywogR2EpZVVDI+FPT/Qjd5H2ramKUcEz6/s6ufYW2bXUsZS2K7whFxb1o9zE52WB6ImN4FEDzOPh6B",
	"y8RN71oemV3odIu1Pr07O3pi0HTLCYO2gBn06T0WG6B5LwJ5hpTvBhwPMcByTIJ/iEQOYnhnSOAgjHeY",
	"ukmNbC7UfdyTpIkibh6nSTNvpkvgbtqZcr4u8WYg71yrXvxZNXwPuRLWlVJuaGUcIXZlOgWdRsWcdJ0B",
	"QOem+gziNM21rFoxzAvFCwPmzY+u1ftg4bSrOcbIYR4O5psS0Zo9LKCYpb+38mHjx2v4MPLBp8GACcS6",
	"cDyOZBiHzhhCLGCl2V/d91AaZYy+bJhoKAVcM1wt1LV8epr0MHP0LKb5s0jk0eY4kywnHBYfLhcEJtWT",
	"4IDAyJpC/pSpNTPyP/rR1aTwOJvjq3lqvJnG6THn13lBciqohn+K6vOtbf9+8rGNc4jRx1uSxVq/7EPe",
	"cE4qSD+7ediUeicJW5vH1gMScXKW4zKHxLpzzmwO2hquUIwO/aoQnVIQQcRZdGfUmMuKDN5oXeom74O9",
	"Z5ZyjLFX29XP8EarbiljiWxXOGzU2VYPVS7DYHnAnKsDCB7nMByByxhydcsjT8KKazHZ54HOLp9ovLXc",
	"MXjYmUGfnsI+wAc9m23m3BAx2Ib4YTkm5D9EmgdKwwzpHdhjw9RNWWKzoe7jHjZNFHHzOHCaeTNdAnfT",
	"jphz+1xLDBtYZpSXrvUT5c8QSrd4aycVBQGAp2ioFhcLLy8E9/AzpraGccQWYf4Ic9K3BgCd7dODGE6H",
	"toUuGzJoX0GT98O+ckVSpttXZvWztK8cZVoK6xWO2Ve61YOWIxyxr3wIHmu/D8Ll7KvZFdKJYK1P786O",
	"nmxL2RFHTjZdPPIJ6tVJmkdsqdlRvm88pRlgOSbBP0Qid4yn2RG4YzwNUTdtPM2Euo97kjRRxM3jNGnm",
	"zXQJ3E07U85/1e/Hb4eSgfHrOXDlsjubefne1AWWuuyk3FLhoSACge4zCAWpmp1CXFNBGVq1ZPO/Q8aq",
	"zBQAUSBczVowoh3m16RAWJi8X2btMyuzjyvwMCtg+0vowB4tsGtXS+SWQTGVHIttcBfV3wIcSzJkJb3E",
	"krwPJpJaxzH2EZT4fAJhhtzQx1IY1jlsJUGThznYNJYH7COOHzkL0BBExjLieF4pF2I30R7uOpT2N/JE",
	"48gwwOABpoZ7ehpzito9m2jmNO/aR3HSLwel9odF4eDcnzl1A+MoRdqUWTQD0j7iudH0MTWDs6N5OrwW",
	"w2DqBGmqoZCkl/rnMdaDVojslSYK3GOYEBK8t1wIDSZZH5zsaKWrdW1ZI8g1ITUEU00wjAw0EotrBBPH",
	"gVG/T4KlWO3/mG1Z5pE1s4URM133MPPgjTUnkl7jYzsJLLOKSZIJUsnRxnRTZQXLRawhraikuMzWTJkO",
	"WVPb32Sd/q0RhGfGRMkEkU3dGxqa7Amn60NWUE5yyXiWIF2Wb0l+ndmbnIy8rSmQI9JIV9zPDOdGGuhc",
	"b5b/pxuiUUbZYoFWhHgFdue0tQ2QYN8rjrZ7yO7n14qN2/0smpU3eNrEe+W1ex9MPX89x5h8IsDDDO/F",
	"RIdQlu7Bgodtv6DpA5UKD9A/YAuKPiyPc65PgdDYhqLDS7O7OusgMcESMZEw0VjscMzg4e8P//RMizG2",
	"6BmRc2WOrvU4jUeWkw6ID5sFAitzruQPzMuptE+ZmzOk/Ts4spo0Rmd0bDVPgDmHUHns4XVek8omTkio",
	"PLrB7wLsSQkwQ9ZT+eSGrLaMXZ//WnO2pwXht0nr59K0+EaZkv/Q/Uavdk2fwKEQsodtMsmnsGE55kVJ",
	"hFLp2a6ii+UCnASL5QKXJW12iyUwD/hSwMRen2znOuANklzFvVnR3wIJFr4F1SO8pdSArWOG+J2mc6Pp",
	"EDWhC8kbTuUBqPQ1wZzwZ42SpD9fKXQIwveWhg0vF18utlLW4svz822z+gScn5/k7JPmGjwSvRZnv+CB",
	"Rl+en5csx+WWCfnlnz7906eL26vb/xsAAP//NvXSlmVjAgA=",
}

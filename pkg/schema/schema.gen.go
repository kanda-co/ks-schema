...
var swaggerSpec = []string{
	...
	"PzNF2mZaUUJN8xtFyu4ENu/9/x+KA9St5wwFlqhW9zXWCPvo4mHP86crSyWq5qz+/9m7lh7HceP/VYw+",
	"u9cL/A//xdwmCRbYII0sZnqTw2Ig0BLbFiyLWor0TGMx3z0QHxIp8eVOrC7ZPvXBJXWxfvWkyKou9ezy",
	"204FO/tRT1GcE9p5VFDGbQiboBp6CqVRcx3r6Naxqsoax052GBVCp0ENLcUoUO1GVLNpETPTnEGL6yLk",
	"C1rZoh1M0gWshdF5n7XDwv4MTNQz2LYojqEeXXgLwOWu1tumfpzLXQ1le/UCF23VslxfjQxvKO55pmw/",
	"wgk5vm1+qAEnWcTx5PK/qbH6+SN+i/hNk9yY++tFY35HrWQe2P8CzCs6xsk4WY7qxanEX6O+8l/3T1GW",
	"D+qEtiQfJD6TvZsPqjAqQh0B/oFRceGWAHGib5nYKcu2YvsumTw/jxyfR8468lnuQXYYnNPPoBKYgT+S",
	"ZjI7qKdYbLjNgSA5VyWB69A77GD2LQkqKc/59iilQgfbN1RK58H1b+gYkxfI+33fqfaa3jXxsqxbqW0e",
	"xf++SPS+ZR/8Fk2d3PWFpq8ulzu+AKzsfuJ5Q7nAXUWXoqJWdgxNPa1Txz499F1ivushwFQjet8ZTpbB",
	"2bL8tkuMsYRjow9li7mz/fv9o5sl9d/J9rOkvRsZ+JpwACulOvyDYyo+ihln+1dKMeRJhkKeY4VlEKJz",
	"URLTKUbRNNXrY1mfSoYjnQt+EUR3K1hkVWt5y1G1tlLwAyp4U9iFVguniThqkXLaqN8W5cjYuxkCM8Mn",
	"UuNXr/lJUEfzlqHtMvmZhGZqIXFGDSwndY1z9ig6Cbeha5qCTjS7bu/29g721ud9DjkrFOWUWXU/txPx",
	"SJCqT+LkEUHrbWQ6JmdkpbQlnlXqx+rdCslQ0D+92r6u2B6XVP3//63lp3WQ7Bg5I0dWq8GFvRSVcZYY",
	"2lxin+hTHINoYxp1C08d1d0pgAzCApafy4q5Zy31fWpdhrkrT7hevciHF2GbO8KG1ruAzdIhdnRCZYW2",
	"FT7DPFPuXdwtEmB1KpBJLvYkzGBrUcke7NpTizBqUhS/hIb0fep+vpvUO5hUQzskWCmVvePVnQULACmq",
	"knPg4QFXBvzdBOp38X+/+F6gg+fwFnm55QoMXa5R5bzgv4VY9m+znuACWlwX4SHHn3FdqM31ux9Yyrdu",
	"cUlCwCEGI5DhoiAkfRbXQmuGaUPLVvQsGF0Azkl9wpQZmaPoJKzHbprrWq9KtkJVS1YtZq2kVwdBtavK",
	"nH2ZvKYh3ZvXLkS6fo+OABNOgUxyHNJR7J5wvjnh7BOBJJN6FEt61ANZIxYmqoePivZubhCDkOc2gt5F",
	"7Ty4+lBdUPQC6rIt/qY6rcn9k0k+NZjgMEB4+xpT+CP23iB4kq7mQkh85Gz/W+ve/RLbRRhku03N1iDQ",
	"fiHhg+9P+M3H3htKmODqYqHol/qFPHnjkF70uwzWDemJikIAVcUUm1dXPEckn/DD7ChzwCBzkM7AZMsJ",
	"cO9hSV0yQkMXtZ4kyTWMb1VLOefK01GvHuAY1+OAjIZYrzDi7hXVxY5wSCkHbgYdLQ7mseMIX+p+0HHQ",
	"EXBXhAapTfEeWXTi5aBBE4K1gHrp8i74BjCf3LQBiPz4Yk1IAdYxD36LIFt3VQACbF1XCaPrzcigoDtv",
	"JOFOwcGIJhy20nlklxZTNi8V2gVahQ7pxc8d4RVqpViXL7npW87rlcmuoVIUkHKdAKPQUp+gTP1aS+ot",
	"QVQMeg+UN//sqa6hwhlWc06RQwwZwO1iq8seYiGm8TdWHi5+DMLL+AcTg0AJRMZ8zOMZ4typQohYqgT+",
	"0/1EpE7FmPqGxELJ0prwKP2ecnmZdFg5JhUTfBVxNCeIK8k6IVjcrhZYJdUiNMAqslLg95VawOCfPXRx",
	"nxzBhC++NN30y/Sc+LUpcF62peQ/JfX5m6a/Tj3W5xxc+BhL0lKbTurJOaW4Fh3Dd5dtg/omZ6tbjxtM",
	"rih+zFGVi17okIdRiGwN1SsXDtNBPqPpPdaJM6dlNIiyGge/aP0qSa6h3lNLOafYa/TqAX7RagZkNMh6",
	"heGiTlNdasKRknKgnGssDuYJhhG+VCHXDDqyiCpukORUB0ZWnli8DdoRDHbqpctL2AN6MKnZgGuDo2AL",
	"6cM65uRvEXMraQCIt1WPhdH1VWJg0J032HCn4GAEHA5b6TyySwsxG31dqw0XWOotn3rqheqnzWW/eF0n",
	"FQUWDKdkqFoWZl8Iasgnlrba54i1wMw3QMq3AoyCvXrgkmnILOSkp2B9JUiuo77q51ql11dq9SDrqx6Z",
	"AWG5wlh9JakuOkE2Ul+ZHMxl70G++voK3Owzh9SmeI8sOrmW0m+MRDY573eBebUXc0ctBQ75afHkV4B1",
	"zIPfIsij4gkcwKPiKYSuv3gCgu68kYQ7BQcjmnDYSueRXVpM2fwp749/DzUDowcIWrke/zd18503BWJy",
	"UjDbl60hAgcH8pkgF7jmx05wvBaTw7slqz+vGakzNbSpY+ELaMe4OiJ6wMUKtarvl1o7qGZ2sqMLI4LZ",
	"6RJGvDtnouvVYrYnYgBWjtq99S1qagIUMRyqkj4hhq+hROrWcU59JKYyL+CYIVX4aITFOsNVkiC5TGCT",
	"Ug7URxTN3AUoxJGqjCiC1XLB9SXakN0IadOQE4sjpQDBANa9bnkZsw/tSU0EHPNxfeSGfh302reFsBX3",
	"gaNrFUc+aH1lEQBoZ4wbfCopALGDL0fXXBL0RRBeh44kfZI/x1RPUK3wqctEhfYoJRSDTAYtFARJ1QfF",
	"x7IuxH/eE97iA8aNOEyVUBgpbhhqDyvxj93MdL8n8VJsT/+X7UlmwJrpYbaZnFWbGfy6yDErD+jch1rE",
	"spownLW4ZsnEFe6oMopPJf76xqf+/xB9sNzVWUHy1kVY1iUrUZW9kK5SyXijf2ON/zfeYpqpiihrMePN",
	"5NWC5IRp+fKaFSXFOSPUTdTiusjMj0amEmXbsqq6vx4ly/I9zg8Z4kXJFFRuCj1qOMsJqcjLi5tKi1aa",
	"oZ9AFvJuEr2UDH9rSqHEDiLZAE87hRFJWTNKCj5RPItoOPeoX5PVvNjhBDrfKymvM9HqtG5LkjXolXDW",
	"uogYRflBLKY9nbG14DT9PWpXW4yNMfeQnLViUuzYdD5Ke0XtoZ87xzR46JZvjZf7i/bPBt01FO/mes4p",
	"4ltLDgC/dLYjoDTu1oLD1bxFepnszBZ/oLpvp7zMk6mlcKiq/XakS+A+ho6E6FEJl0tILP9HGhNM58zX",
	"L69YjKnFZFsAqnKM9wPSdGSdFCBuWwWsfQOo8FsbBqnY+zYQAGL/DiGL+yUKKGzxBShnSJTnBq9Ng2vd",
	"CsOT8kiCuwNblANTsL5VTxgKNkd5RlfRFeUZndUORcgMYE3DkNXxpFtVuIJ5RpfqcfKMduJ9oZqFzdzz",
	"6BnFWpowgM2NFF9ipwKtKG4JpzmewGwYbGIx8hzvvtX938W5bQ/Mk4oDGNjjQoNZ3au0LQcc8S2BaYVe",
	"YEBaJYMbRV+B8O4ozhsI+ERQ7x8MOFzFcsjLEwMoKutIW7tnRXMV6Zte7zk5XL9+iImcAU4PsV5kJKXT",
	"ZBeb/KpEHUrsbB5mMugIZzrFM3QFXp43CM4B+9i8U/O84aXhyKLoFpgkBKCfpn0AFWCS+wX1YB116rcJ",
	"tZ0UAoTZzgwjGHtzRDgYzxxeuFt6QEIMB658PvGFA03dqrM34VRSk11JNtmv+ryEcpACzJzSRMmAvV9t",
	"NLPsKS9m/YPkw/nliJPZ7D/G35BlmjoEMdE0JOjWBYcXSM84jbfHopQmXWQyEtIHV+oJUSsc2WdUOdYp",
	"0eCWwR8noxCBH+ejCagHslJYqM8fnbhXmHAiFIevlAE5huPUV7zdE3LY/NlQcioLTL97k9ZfFcVf9zg/",
	"/Fs+F71Xrp6xbjPYWqtJki40oKoq+fFh/SCuJTysH3YkR7SocCtOZvNj91tNTrzufiTHunxYCx0XFzvE",
	"AfyXNx/R7hejhLbSE9tBaYJmUpys16waeqCRC+St6hV3jKFjHEJXPIJzTkv2KlD7C0YU04+8CwC/f+nE",
	"0WJ60phyWj18eNgz1rQfNps93/4gbmb9kJMf+EFUmhOKxz9QgOjDZlORHFV70rIPP/34048P3798/08A",
	"AAD//3mpmlV5uwMA",
}

...
var swaggerSpec = []string{
	...
	"mHrdZrNigc6ETK+uF2CGq+MMC20hEZBzomZn2oz3DbZ1TnxCgyVc+lPjbG0/fX9s0nrUxvmzxtB3uLlN",
	"WUOyRpQjh11cNaSrfUiyR33T1BSS2ecuKfS8NLn00Snba2/v+sSkWN14KjM2TEN+sERRP9v5xLzEuwSN",
	"vt9zGfFSNgQLIrL2hFF7yBO+o+TBIuOBZu48VOjEIv0ZSaJgs26nRyYFJDWPdDUAwfaVBGEmb8+A4SRm",
	"f/FyiEVaH77xQde/h4cvE8NB49RoP8bOQ50vyz+n03opTv4HLmkBJvyfHCLm4mc09T6eJdyI8XOgtkb0",
	"zN9uR6RzotLH/tpa8fN7Bc17WdEHjQDPaHK/BZU3R8iyN1/GYyHQ7yyk/8A3HzjjQ+R7ejAO4YxMndQY",
	"b/gGEr9tb0+jwiWMwM1XRMP4Y+JEeXg4K5rJca9ojrd1Oif9I0gd8SY9p62L3XrBVhddCc4adGn13kGD",
	"7mONBYSWuy9b+g7cLvPbc0Htp2RY5ryYbxDhTUktzT1+xajl6wdrQ95JbQ304sYxfnDddu782KxCH2rS",
	"uoFFEeWkN3yTteDPWgM/8M0LRao088NgLt+3N8tz7B7tg81Esx7aVB8OfZ+cF5McNB9HL02DMXu17XMI",
	"qXM8J608rH7i5jBl66tqF7CkbG7bX1x1mz0TBpIKgbfgGxsXOZ5N06bFTAjlkR03t3+W5qfEZtl6pbjC",
	"5SwZ8AvUHGQ7244D0dYXMf4yuY7rwtHzNvfJTrznIUpn203pmamU5DPOQR6wf6w8aXRgNTe3JZjTdcgg",
	"vv+2SpAIkrBeqeh1Am6jM74L5e82uVUAYaHuVJFX4JinhX29mEQ0QJWXjIbsvEdW5x5LF1gzUbgcT5mv",
	"epQ9lshpPb9Z7G6G85RX7EaKNsCXWKaguYYRibmmgRYBU/ZBLWg+3yp52+A21jfrBJ4583nOYTapjv3j",
	"vO7op+P14VHQpIcCnZ0nzAGLSYl+wPMzZbSIEXY9+64QKMNMEhU4RMHXd6SyC/Lx/1ytV/9b//ME/hye",
	"g9UyyvKwu6dgkh3d/FoCO84wM4zxZyRUFAkBGhl4zvmWUCOk7sIa0QeprV4X6vNHmTgS2I4zeZbljLQC",
	"POs+k999/93vn/7O3DfyL3f2j6/vfv/0v18/u/gPuI7EffIvIzlXYa0HtBtgK8YUP3oWc48VBMHqvNMf",
	...
	"KXM196SsianLxQ3ijULVEdVc2fxyQbwAH7RobzSCm288lxj2IkPV8W97uKdVzwMV1LRob5JAO3og6Mgb",
	...
	"EZ/mxeemwhJ4cd0fTRDt+CEukJ0GEgRLCELB2G8bAq9O2MHbwjQA3bNKb4DeGW+UyWiMPGay7qrZE56m",
	"FsOJWoyrjLPMu7n/lmwkVcSv5E59NFLX9bg5M7zXnWLI8vxNhneYMqnaTZOMi8wFQVJ1u6sCpeQ5dfub",
	"bd2SamM+8x8g4CrL+cG+M9VWlORABC4zRnZY0QOR7RCdUGwrN/DaYqa4e1WPZLTI4LimH3NeguhxxPBY",
	"63OQPMP14NZjQuS4ua0RrrFQaCt4hWhlQmrevoZj5jW4zbaVRLdU/zLv5gZD2af04G9Xrlta+We5Tks3",
	"qvaQOGBbP4Jw8igE3k5YWaKNXvNVqya6qSFBLnJc5k0JA0mOgJ1lTYTkDOWYIfPkGcIo50IA4hhBwMCP",
	"ThKhbrWlZait8ZtC/zwUuiQtgDYRylxcoZV7WSLG2UULfnf3iXtY7WR7kHp3Dk14oO31RIvSw1taKiKQ",
	"2VG4bFGCNsf2nZaYPnZlS2Bd/9acBPsOpgf31YDIXKhfPAPiMwOfy+TDwXzncN/CPPYWsxGS253rwTRf",
	"PA+k1YN68RMLpz29Ow31ghbPANYubWCI6xEp3z7OkxTrUOOBdm8MNKds3ljolrh10yKuRb+Z3oT4ck/U",
	"fJRgm0Xw2K6NP/4DhdlGoXJ7Ni1vLG/Lpn1VqE/ocJnN3a9x3Y3rLZN/9/lZ4EliDzdrFkfywV5NkvLr",
	"CYH65ZE33KZZHGnDXZoRuib3aJZB1wdVGk0MZ4tQHM2imS2OuDnq49KcSBvbmCmPX6qIsbc9L5ny5pDR",
	"mbSHSHSa9nD/4JdKe8DNkPYQyRNkK4jck8J7PXNBPAGgjwHegb2Obb35NzbBGSkVBofHWKo9VxJnqf+j",
	"i79UlgLcLFqaAITnShNJdyxN+Vd0x361Jk1w1ioWE2pPNelVaLDMt4Ml6r/FuwSrZ0tUvgeQzS03IwAv",
	"aS+D7lga0jkSz92fNy72/FvRUs7Z84CiHzveFTzzPDPitUgSuphX8Di1pUM7yfG413M/G+HDr/ix1d4G",
	"cooQhodZzlOQ2fhX4fHK4iJgHuIiZO8vwJlxMI8jRvVP+EjY52R6jJF+EA1bIgP042HjfLCeFLtfJqmD",
	"yNgSyRzExqZonIqPLYjGD6xemjj2FqJimoUzXwp9I4qGsi2/xO6RpBg/tq8ofaQtctd9AuEaNpPq4BJQ",
	"1ghSerQtfEEZqvCO5nAX0INvlc+DG9LiTILCwnjlNNw6Lmpn3uOivMS0uvBuZ0+y0x91TXc3+6dhKwAW",
	"WWBDHEDuV0l2ODc53hYnQQrZQpkOZkWKcF4d//VntjR+/JBEmeTWifO4firMhBqGXCR0Q463XBSIb1Hv",
	"7udYwlLvRuMOt5N5UeQdzhUKr31GFVb5fmood5/JCYPBfbQFQeGjcE8TI3UP0kUGaa81vrfxOCtgEKQy",
	"zYsZBE8fLCp0qfkreFgP1jRVEvko91l+mL9kuN577yjN9t5bCSfxfcm5JOXRcCMp/JfcY+zydpQXH4RL",
	"/HedZrGIu19soTzig2eYBGiCHOYDFnFz7/HIrn3LMKW/zWuHH09xm/4jSIBpAXyo4gUxxyRUIxjqPWf4",
	"sCo5Ca9WahVZHLPMQ6MLJ7u7MXW1f+3OqPS4yeCgx0p7gkvjWiSFzV9MlY9IoSSW9IKWR6lIhQygC13V",
	"AYw9tFv09fBO61Gcw0VwH3VFvHiZPo0FMgO9eOk94rk4lMegRFygLS7LDc7hwmNJxIEIe6ueR5IXL/vk",
	"qLGUWkeOCtWXrtKncYgcjFF/sC0URBL1m8t9votzNpqn/JmDebeVXLT3XiWXv33ilfzJHpoYNfJcv0jt",
	"qYQbs9k9T2IM7+N64KNB/SduU3Fm8DsPbeXFaYeWNAZS92KbxyjdTAfsAmfZRwXSP0yVTyOO7Fn72Cr5",
	"HAIxPvjLFUZnIXlEEL0xTxmntq5+4JuHSRb4gW9OyRN4o+FaYIrAG4Mvh3A9q/HEgB/gfZePsVwBoyPp",
	"AG/akR9m/Y3AY5MA3hgeWNz+v8FUSFNv/czc8DeUHlXc7WuPn9Peb4Kugx3+hVG3v7kfI/J6TC5+ScQM",
	"9vAXRshg+z5OxdSm/Sen4sNJ/WaApE8v+ZvlMlUEX+Pyf9bJlV8hv7mI9N/s4/4RVOspmYMh5uUtePXC",
	"oH7Txb9Xd59erBm7X6v8unvEfjHnKNxGQfuYzxD0FrEW07H04u49evfkTJBYnGbvWXfm/cA37lWzL1g/",
	"WmqYFzcwK7qrd0xB/6Wbz+A2PTuZ7rGybpr92cS4bvj8EOAlZEb3uDsU0fYN9WIWg4p8T0cZ1FT4wiw3",
	"i5bl2uEWwBO17Zyzgr9iSpvTH68U1qJjxmlBPU//WMmCzwf2QU2psBPFQ957WD7KNhqzXr1fK/N4U5yj",
	"y5aaY9N3/EJAZ3GEi9ckpIit8YWpjE7Ft9h1R9CWpjwcqHFIp63f6NG6BL/UeMS9e4l/jc5d71nuuGvX",
	"e1b5NzduvhtX49CJW6NJjt2QI2fFbLetxkdugl9JvuXNlx7NNPziXu+1uJZEGRLR4nO46xwZSkPOdUL0",
	"6Zq0IKJzRlun7MO6YoJIwoo00/0M5UtiuqVQ12DuRF9oHNmvFobqB1jf8Nz4Uv3dcwhMd8wF1UZvtDDB",
	"N/Lpo28f4U4LO/+YveppVLhtYU6Majl2io2GLTomeBaKp83v+yiZAyW3k4viH5Tc/haR7mhknmP/fHhN",
	"w/vpeM08BRpNAfiRfMx07GeN2v8dDvvFCbvA8wk70oHV4bOdyHgSlMXmx0lZ/JEk06AswN679Q+3KT5G",
	"Y5sTtUAy+2hL0jmRbfEpqNwsmMjLPGjkgxUlsJOOLrYykj1q40cPk0H6sov1zM0irR18C8wkrTvcOSK4",
	"GY4LU1fro4YERzNL6wCCh1lpE3DZDNMFxgMjWBvSu7fmZmacdpwwava6AO5nZ/qO0HyQfbpAyvczUMcY",
	"YD0lY79EIgc+zgIJHGxQjlM3ZTMthroPq0maKOKWoU2aZTNdAnfzdMrle+Mw36VDKj9icbMErhzce2Jd",
	"fXs3rHkMjkoPBREITJtZL5I2DLaC9JTtf8eMM/eUJhzXW7RghOcnSYGwOxFq576w3XzMjkhx81bmYAo9",
	"2KObXG62RO05BHpyLPdBkGe4BETD2MgFKz+b4gluN50gctDDAyMkTtseYtIs/ghuRVkBI+95I8kNIbXm",
	"q+s5T/MaaBSWN2N3GunyWbAUm8PX2Z4H7+G6SF1mAnGZB2+susQqY1yRTBKmJivTHcsKnstYRcqoorjM",
	"tlyTPmtqV6bqdFkjiXDP4mbwTvOga6hiTli2b/hmCSqYh3MzQbZECFxm5F1NxfEEIRCl1x5LtCHEC7Av",
	"aYFaIEG2asZyrOxW1i+am7plJZuN13k6TPDKq/cwsQJ/xFMCBjKAdIFRA9lDpaNMMOHx+EFQ9SNt5gXo",
	"H4kkyCEsD2MAzoHQxhRkj5cWF1joITHBErFFOzPO0OOYUS3pd//5OaNTbDEIOyyVOfqxh3k8sp4lwr9s",
	"Fghs76WSP4hMzKV9KkaxQNp/ApXVpDG6ILXVfAbMOYbKU5XXZU1YoRkjnQFrKvwmwD4rAWbJei6f3JLN",
	"nvOby/cuJ3Yk4PXSVvk302Yy6OWybH2vO2QNV2WW473jORZFSaQ253nF6GoNfALxBfBVt2c7nS2sFh/t",
	"eYhFkboHpEddR5Jr6FWSvBFUHYEo3xEsiIDLjq5eX2t0mLv/DMkaUa6uVnulanl1eblvNo8gr/pRzh81",
	"N6u7daTGxVs8Uunq8rLkOS73XKqrbx9/+3h1d333/wMAAP//ZdMuqr0AAQA=",
}

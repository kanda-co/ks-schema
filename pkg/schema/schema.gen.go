...
var swaggerSpec = []string{
	...
	"H4sIAAAAAAAC/+x9bXfctpXwX8Hh0+dse84ochxvk+qLjxNvU3nrVBsn29NqtSyGxMzAIgEaAGc8dee/",
	"78EbCZAAyRlLMh3li60h8XJx3+/FBfghyWhZUYKI4MnFh4RnG1RC9eeLPGeIqz8rRivEBEbq17LGRY7J",
	"OiWwRPJBicmfEVmLTXLx5SIRWBQouWiaAdVskYh9JR9zwTBZJ4eFM05dLhGbMpJuGBgrw2IfH0C+BedA",
	"0B0JdqY1EWyov2kQ6zvWVU7OBRRBNBSYoPTL+AjyPfgy2vPpSM+noZ4lJWLDUyhS2FJ5RVkJRXKRYCK+",
	"kt1K+B6XdZlcPP3y2dfPvvnq98++Xsip9MMn7UR6OAAFsMM1c2Ii0BoxOWlFuchorlimgkIgRpKL5H9/",
	"e/3i7O/w7J831y/O/gTPNq/O/vb2bH/z/PrJ2R9uzDv553PgPbr58PTwr+vv1zfXl/jm+kd2A54/uX4B",
	"5ePf/SZpYbOzgnPwT1yp+bsIWSTvz24hyeGZRMHZDudrJPFwZQE+HBYJQ+9qzFCeXFxbkhm2Wzj80azx",
	"ppmELt+iTEgEvKjF5meuOd0XKVjnGJFMoYYhmP+FFPvkQrAatQtp2gTomWMOl4UELt6/adP0X1JaIEjk",
	"AKiEuPCYQD9puze/u3PjwVlxHuzDea3xEO2nWwT6DmudmLKpNpQMdNOvw/0E/fnHP3u4qRlOvL6CAtkm",
	"1J/RLc6H19q0CfRntBjkCvU+0I/Xmu0Gutomgd6C3iIy1Fc3CPTcIoZXWHOixzqgedPnv454aZ4xMxiC",
	"WvZzcNXC74hGwzfNdEFJ3EJcSGn4USrlnjgi0khTswb96HlQelZIs9ZUfSnbhzTkKazdwZ1ppGew6wih",
	"4FtIbl9kSnMF9JF+MWLhTauogW9Gidh3xwgozf7h68U3B1d3NxNE7T6nTKQBo6LHe3q4PrsJ/OnOIUcA",
	"QbPQRa2HlN7qXFhC+P5ug7JbWou/VAJTJVs54hnD5meSmfeAqiegwtktysFyD7KaC1oitgB1lUOBckBJ",
	"sQdbDM0rADM1iCS45LTrBFZVsU9XlKUrTKCWjBxlym69pUspR3CfUpJK769AqveN47T4sIQQ/x0tK0j2",
	"AdaxopUyKPQjLFCp/vgNQ6vkIvl/563TeW48znNfJA8OE9gXQA/YAAMZg3vlSEJym8KWl4emcdle+Y2D",
	"1ivTqwRhK2beppis6Ni8Bl+XsqnTtaDr0a4vaVaXyMBr+mlYPjQEL3CJBcpT815xY4FSwaDUlTf9FakB",
	"pjpCP8Ic0zeoMKycUSJgJiauW7W161Zq3GeKvsfRs4ER6ujBwIoyUHPEwG5DwQZyACsMYJZ5fmjDLNMI",
	"XhP8rkYRuhd4hbJ9pg1zjlawLiT8DK0xF4gpE2cJ4z2kZEkhy9XfRvJQnnIk6qpjscbga0AYiis8lphE",
	"rT/rPh1mLZGAORRwrPdr2+6wSOgwnumOIBZB77uaCpRWDK0Qs05xi2VC3VctorvPFR9LPCsV6YqAGh94",
	"jft25RZXaY4qyrHw5/+BOpP+TemjH2hIwjAHsCjoDuVAUCDgLQJ0R4AdNGjMGpGdRK03tEA/qeaWUlIM",
	"pqtcGYv8JIFwtK0eoSs2HUvoaaGgsXMYKGAhEINrZYjSLSxqNAbnlaKSdChMTxVvFns5Ah93vFyPRQ8A",
	"zABADRDyxDDhNZOGM82t9j1CSysapkua710dTXSIQXCGcCaZqEAZlyy6hjzlcKVewkrxBhUbX2+rIYEa",
	"cqrWbhV2C89orqWdZ8Dr0uN1bZBcBiJrTJDqpWZnOMNQeSbbNNtAtlaszQUsCj001v/fYpFtEElXWLpw",
	"0oEtKGVpAffqV5aJbQqJ1JVZzbDY20Gg9E8kCXeY5HTHVaOcUsXDBSQ5z2ClkQQxSzNKciy76EdLKDaM",
	"0lI2zhneoh3c6yEqOTBXtFEcZ4dcYYaqAmZK7su6EFgLrCWZ+dUj3FHmtiVczVHK66U0uAxmgjIX33sF",
	"BPGUT80R8Do8P2HWnZR6IvZpYfjjQ1CYbDNgmvXlqKM2HLbpTxKR7kVAXYTwEhTZsGpqHZKearKejZMV",
	"G/RZTTPHJxpPpJiWIOru2KFs8NXtGAu3bL8m1dHtqF5ExfrQB1EZoRAOGcpxKGwsp7jgrylBn9ZvV+A3",
	"bDLdYHo63k6lBgPtYH2X0wZwaY6EdX8HfWbT/qVpfpDBm/IaptnLBsGorAq6l2BNnfo/mh7O5CaGTGkk",
	"dDXv22gxRha/oXLcxQZzoHF4fHKxggrUCJlvRzKTRCBGYAFuMcmjQ5DcVbk6dtaGbMhN98YOJuAf1qV2",
	"s5CtK0tLgh1nVv0cWJQdJKqAOF4TKGo2yqBvmoaylzA5uCZ5kWWoEipIMjmLXPHUCjEdRul0hzQcOhFo",
	"flsxSxZJhUiubd0KE8w3qlsFcZ7SWgzGV1qao0HV+2EaoPeG7k1wESHIe4WdYwYaTU952jSgdILqoCfc",
	"QZNpEdtX+EfbyY/YaFhhxsdSkqpNlEELODqAbAI+ZhNhyL665HJW4wLmZLrVZEP0eNnq9I4bUzMmqXw8",
	"eXIoUEpX6RIz7fj5mt7O/G8cyJaAroBq+QX4oyKnjHRrji7AP/L8vCzP9/v9/h+SySyxZa8zgTV67caU",
	"O1II7XfGM9O4ZK31iqORSljopLr6w3G311YF9QehNOdpjgq8RWx/AiU8Xp3EnSXEOSK9PvrxQC+GBSxS",
	"qfJq7q56h3O603krFY2qtkzv4OR4S1lmElkbuMRCq1tB0yVK23YcVZBBrcw5JmsffWZuYOYOQYfzvED9",
	"NanH8TXRJS78DvpJbCu82KdaYI5zYLWoS3nJkTQ50DiTp++k6xGlNDgjBjfTGdpiWnPLWanRTBO5q9dd",
	"7OgR3RnikqkEDjKOQARqG0RrkuECNA8KvMVkDXZYbEAFmfGXlefi8oUz/ABvCFSgXqzTPgz10I0cwVZB",
	"fal4G6t0sckFeBG8+n9Mn1sV1KoE0y2q6H1d25PECHsFkb/oqXw3IWmUNmiNftSk6N2pkEkxW0JOEDAY",
	"wvi7XSdHMEeHHpFQg6vkhr+fNkrS7pqDzlIXyc1Mug2P79ohklcUExGix0vMUCYoC6cpNrREJ5gUvcGQ",
	"qZxZQGwJFamzST9lO8IdMSqpHax6wIfcm5dOxrXDhB+3W0eEGbXRz0vI0e+faQXdOHRPnn3z7JuvHf/E",
	"wAPsCFMzan+UJmc0iG2Gx3cWKZa4RDY7OzqtbBzOT45WJDRjxAzxySFrqKohxCs6X4HyqCusYx7ERtx+",
	"22zIuSIpzbJaZYZJfCTZEDgN49V3Zs78BI/hy17tXTPYaBbWx0h/ZX34bnp4yodsST+HFKNKflxaqiWz",
	"n9vqqzIHGxwVq9T5LbWc85MhoRDTW6Pi67jzsWaU8xQSUsMixSSj5XSjtqE1Rxta5Cf2d5cwFYM/UBFA",
	"ooecqUO9QcWqN1aQyVzqhFEWR0ZQ2hmjLJS11/U/PSGKG4o8XIBVIs7helBv2iZjKsu2C63jj9qNeNPw",
	"rbu9LVJYVQX2qgj8p7X0MFPpwaNdskjMi065j3VVTFdGt6qveawkAwr5FqVcG7Xmtxy30wKvSZNDG3II",
	"rNsVFxzp0byodXKhv/mCSY3SmhUD5Za2GZDN7jJbEHToQ+STS4jWP+XGczttGz5evGtG7ezJHFnWIjuP",
	"1bb4hUQPVDDSK7D2oYhR4fKqTwBcbZ+5EaH83a9LjxBddY7N9jpQKvo5VSMfAut6RZeBtC7LNnirPRNX",
	"NTkayd18jnHdW7pUVTBmtOdBr9yPsaZLTT/CjBzA8GsZg/tzHxVWOMnxKZt63oags+gpfW107oTT1s33",
	"CqTaGiOnOqp9WEGmkgftkxV+r+y//u34QuZRND44Lar3YviYEEjucRsGs7tuOO7zTiz508kMhPjBDtv6",
	"lUOr8o35qCpWQhHkpLd0mTbgT5KBV3R5KVAZZ341mRqpv8pTAkvpDExEs5xaN+9P/TE7mXrLdzqOrnSH",
	"IePajNmH1HpAoz4xFD9QXbfcOE0Cl6jAZGrfn2xzsyfqRzQ5gyvlpGlfLbxH2mx2jijlgZyqzZDG+SmS",
	"Dl0kggpYTNIBP6mWvfIgM7Cn2roqxhWTm7A9Gyw+/Jiak4+s2bauwpidGavvOaHsegvdUxjRbB4UU3cv",
	"vTXd+AziOptJmERKa/Vd56lmQZJ/zDZUDGfTLdK7GhJhzpBOKkXVRcqnFIdyse9WjttaZSvs/drl6Bku",
	"NdhpgqywGJXmLZy+DybZi5kqjnZVW60IU45cT6Tz9D0qjR578v+TRfLv8p+n6s9+4bbkTxXsZs1xkFFG",
	"tetrCGw5Q68wpEICMU0gVtX8f0qhoK8NYseGB3RBLN9sY1J3lpFy32aewVpfTNanbDfASUe/fvv9t797",
	"/lt9NOsPB/PHV4ffPf/X9Yuzv6uTW/aRe27rVGW16NGuh60QU7x2vKUOKzAEZawK/a0Ft9JhoNpI7QxB",
	"EQ7Ft4gYlMdGaNqEjiWajadTILN7ViHIerF6A4KDCm/2IEKV8jixhLRRw3rbM9v7muf7b68cjSN/eTt1",
	"psvoeT8NShT4n6y/E1pBeoz+bLuk6H1W1Bxv0SmdMTmu88E90CsXE1hqIHHcWzKnNcvUXnabybbYl8Em",
	"UUK6RAStsHKzS4iJKgrIUOiwgx4P0BVo0sTDpOoB4AxGqABTti1+oKLZywydiLXPO3mX6HF91QEUmNyq",
	"QleGzKoEBUsEVkhkGxTOKNzRLqevcWPDEWfZ0R3O0ajWG+XuNjLdYdNsAwlBxeTIzyXod6ZvL1Kehhbd",
	"+45DWYZ0VvcIprJdWrZaMUUydcasgCQHYW94i9Huno5d8ubcpd430CXdLv7GjpMFqdyy8k2YKmMy/F3L",
	"Lq1l2KGlYxn0L17ypuzy5jiOCKHNJhzutnrh10L4uymE14iaWMVkSNmmmPt5mZqoLTG35Nw8yDGvah3a",
	"ZNLQFYWtY69JPpyjseSM52lmXIfeQXHIffLx+rHHiOyEJRIb2tmzyCDfOAJvfmaQSWwUFHo1XBbtZqCT",
	"TsdHkNEM6TiVnVm7dy046LKnoE+vK9XTgnMTMgFMQOVT09kFt8nMvgaTfyodiI7JeLxLYb412RhLiZ82",
	"aA/e1lwArlEOoDZqgqoYX7rnqo2gRS5f7zZQ6BsgwG6DGALNvRC25QYVFdJtKbsFtBag3IOKClNJypCT",
	"6FU9mjP4QGyQTS00R5N8N/KvG3W9lVwHyLHu0ZxkBWu8RWBPa0CJ/I8Bu8vgDHrKUcx3qTOAi7/LAeDL",
	"PUfFKlkkb2iJKEGhprqlagyWaAOLlb9Y6nRSC+pixyzwxEVp2uHCpNwcrnCQ2pIeEfCupgKTNVDRwCXg",
	"cAewIojkSa4rOz2aqGYrWkufqBZ6EJ9oHc7bYgj+U2XeHEz8ie4UuSVt9bGBJZIRBoA7yBAQkissrXeQ",
	"t1x5GmIQ5NjG/O3enbrOo0RSBJKF2np1IHxJDXDSeAuwgSxvhMillK66Vgs8DbaKIc7N6a6psPUExQ6i",
	"YA6BeQpspxw86yhqZ3keHXrc2pVJR725gCw8ZRksFIYC85UJEwkVCEj3vRlhKFTt7hj1A3JVCn582ke+",
	"5gKWlYROA4U54JGQUFcF3eE8tsooGL7c5UxNhdPAGeg4nZqNvRBpAsVxgRs0NXeN3qCpmw2cc1GFmn6J",
	"411Uk8oRh0pK9RN1eKFuFVbkRol9pY931Y1IjRxk9LATmCqycDeB5MI/KEmu5vCJtMJkjVjFsHZFnfIB",
	"+9jxrnmdbQDk4PIqLigTq2maNahO2vi6emUkE2ZlyAXfLW5Vt3JQgrPQoA5i/LtlAnVPUh5Uuaa9dmFs",
	"r8F2AU2Xe9l2sD2HZcu0ApMu1fOG7MMWCnGaor5ogeCkfVzvHMjnfny2PZYXKZ2PHtKzt2A2cZzOlZzB",
	"vMSk3cA5KyGBa31jjHnCBVytQtczBS/OPCXEMwN5x7xitaOq5FrfYPNGUlhzxLcIMsRsUawivVL/6nEL",
	"40aIKjkc1O1EmnP8s1DKtQNvEFMxyourS6DmgA5z+E3OVCNuG20R43qkL7948sUTlWmpEIEVTi6Sr9Qj",
	"tXG3UUCfwwqfO1WiClEfZA+m5PwyTy6S75HQm5IYmZNrFSVcr/rpkye26tekyxy36vwt1/GOgW5yVWC7",
	"BdpJOXbLzpI1FQAWhSlXkACqJkY/HwHY4MEFVbEemL0m6H2lD4oh02aR8LosIdurg8Vd4BaJgGsuGc6u",
	"8cbcqdxH+xXl4rvmJkDJrIiLb811VHeyrgbP/ZVJkABBO5B5EGhxkc7Z4SMZ4SPgQrkH2YwIHsBan96H",
	"hSd25x9wftB6QAbqfT54qZ63nFBBBksk1B1x170LSN38M1YYg+pcqtb4+lZen5ILBykdld6xpzefhuYa",
	"MTlA7zFX2YMZUl7D2AcxLPDDavZRElkq8jkTWOryidSt6pA2r+dD3Ye1JHUQcfOwJvW8mS6CuwGb0tzp",
	"FlUxqsUD+XEammPcOAPdHJ24BnEN+vXyRjw4eyvavYidQfCQ/+bO/0ACNwiV9d4a3pif89ZcZNcltC9m",
	"Uz03O9yw1td3ln1+Jj1K7L7bNjuS97y2KOUXIwr18ZHXd9hmR1rfXxuga9RbmwddH9Ro1CGczcJw1LNm",
	"tjDippiPc10mcfEh4kK8kK8fq4oxdyLMmfJ65/tE2qtTzXHaq8PRj5X2Cjd92qvtdYZWDPENyp0Lm2fE",
	"Ewr0IcBbsBf6PjH7iQlV3uLeXqs37sX/kKkspU60xVnqv+Trx8pSCjez1ib6oyYnahOO1yRO+Td4TX6x",
	"Lo1bEdTDeVuMQ1c9qXRvfJ+Do6NOlChdoU9eDQA8I76VKI5DOkXJ2aPww5rOPakbi8deehS97xSX9zGB",
	"iUmuWZLQprm8TyAYOjSLHE51Nc3uR8hbVA+ku3IfhocR5zHITMord3hldkkvB3EBsncFcGLqy+GIQZPj",
	"3575OXkbQ6TvJcDmyADdFNgwHyxG1e7jJLWXDJsjmb102BiNYymxGdH4gc1LHcbeTExMPXPmi6FvwNBg",
	"sqLn0N4wGeLH5grK+2GHZvgIwiVs+ibG5V5/BWwBODK1/2eYgBKucabOpDwoo0yHW50k0TWOM+OV43Br",
	"uahZeYeLxsob3YtARxTbuxqxPbhF+x1luQwnOze84KZRq+s695a02OtVK3dnQ+9hJoB/uQsoocg2Y1M1",
	"H7OePpm6dSJHwL+j9HlkpvZ+1MAk7Rfhbx4iBHPpNzEK8y63mlX+R/KXd8+rklIsOHBR7rJ8vwhEc71z",
	"o2Wc7Z2PbR3F9wWlHBV7zY0od7/GEGKXd4O8+CBc4t7cOYlF7MmhmfKIC55mEkUTYDHvsYhde4dHcDXI",
	"HeoYzL0aqsurGPqNSQeXV869v7OjQghKQBlYwaJYwkydg+aIbREzZ4ocolxeOeR4qy/wjQVXr/RHVO9f",
	"Sl7R5TGZLPVx1xkmsewXoQ265aqGU1ev1E0Y9+FHKowOJKzeNjM/jH84AI9JU73VPDC7DJXGlE9TR34m",
	"pqQ0pQetXXO57+eUnYjQtZeDmhl1u+mnEJEXQ3rxMRHTyzLNjJBegilMxVha6ZNT8eG0ft1D0qfX/PV8",
	"mSqAr2H9P6mc6hfIb71vC/RRLZekq5XMnfnhz+kdPr1a0+GMNPlVe+37bIp7bODVXHvSB73/9cD+Bnh7",
	"g7u9nMPb+o6zN6NbNMjgssErurT3Pz1i+2iooa9ggCQH9hNK5kX3TpA58Zk6wA7UwXfDahJyu5j2Wqd2",
	"md3VhLiuf1GLwovPjPYDBOqV/q2+NjWJQfVnYgYYVDd4ZJ6b/XrObC2tAfBIa5t1blcPUrzzMYdfKNW9",
	"j2dNUE1zTUF3/fjehyDGOcKG35GqZtPikWmAVmM32LU1b3PTBRbUMKTjzkywli/CLxUc8Nav4C/RV+/c",
	"Rxv21Dv3if7qlU/3yivo++QLMMqxS7SnJJ/shXOk71GOVFojkj8y5abu4Jyra6MqB47za6Rr7N6fG62o",
	"13EW+vSB1j3U1NuPoQVsmSNtqvR7SjgyHx1mAp9Zh38noXjcNH9MaLfFaDcqFP+N0e7X5ENLI/M1hc+G",
	"1yS8n47X9KWEwd2e1+g+ixFe1GLzM0csRtgSzTJQs2C1+GwWMrThYnB5P0WTr1Fsl8FA69zk+nCbH0ME",
	"dmCb2+bHIIGt1JDON49iu6Xud1UeppzE+xrTEXUlxIN0hgUmpINKSx1vwcMlJz/4X8G5D3H00T9QhEL6",
	"sDyMWE6B0JSlkA4vza4+pftZozBLhIR2YulKh2MGPav+p7w+JxdrjC16VS1zZY5uecs0HllMUuGPmwU8",
	"d3uu5PeS6VNpH/PaZkj7T2Cy6jhGZ2S26s+AOYdQeazxOjff4hjMC6D8V/X1WXGISV6cyCRV+wnFmDm7",
	"aj/ldf/ByFW7bTE1Dmk+NTbDEMT5DJolhF3hcOBhW93r7tZguFF5EDyMyh6BywQZM9zaCmCtT++OzE0M",
	"KFpOGNTE3ndJPyclPEDzXgQxQ8p3g4chBliM6djHSGQvRpghgb3wYJi6saBgNtR9WEtSBxE3D2tSz5vp",
	"IribZlPOP+j9nUPc038N2e0cuLJ3wt3sTJl71VaU6W+ctygIQNB8uzkORf8b0va/fUpJavbS/I8oz1Ex",
	"ghKyW5QDyNV3cIn9bvXMCtMg2QNBFbD9JXRgD+1R+p+HBpiDDPKNtyfZF4EdWm4ovT3/UDG6xTliA/x/",
	"ZZr8VfcZlQHT3LtCwmdC22QSG0rWqpD+EBherZJFQkuCk0WS17Sga3wEF0YANchoyvxmpdw6QDpUtfS4",
	"ObgfcFMUcT/ddn0j0aEPbWt61aww323jF+fnm3r5harN/yKjX9S3idQzvRZn7+BAo4vz84JmsNhQLi6+",
	"efLNk+Rwc/i/AAAA//9hxFkxxMcAAA==",
}

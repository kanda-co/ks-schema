...
var swaggerSpec = []string{
	...
	"Jq1Ol6rqMKrhhIU4x6LwkuBho1amOE82Akvp5zSEDM/5HrLhrV1US+8rZyBXrTjNiUjkFS5tXkPQWjMl",
	"cJ60c/21sxruOz8hZV87zyHnIkkx4+Xe/pJ+9sP2rU+QK2qx3aQ+HEh4mHMu4J3POm8g5GdUMprkcFXR",
	"XFeUXmbDjcCMKpJccXGpTMJueLpMqiqD1NhcJapa2VyQJfbSHcoGt3VJG7XtNIg5X6vEPcNgfMYYIBeS",
	"FmopBSv3xWaELPXGIWIsd6JGQTtrov7f6qYFBByZLupkijndbO1gUmEqUiyJTa1oSsGmZDJHWhroJFzE",
	"ublZm4SXMIc0x5mdm83HGMzMGHD4rFMwBmUHB/Urzf0Mc/0WMna5DHPAFptEXk0nW6XKxfW1l22/nTgG",
	"TJjoFRFgi39yfoZgDF8Oalc5gUrSVdoRYfJmLB7ef3D/AcjoJWHwBMLiKygymfIB6FNc0lMvvRowkd90",
	"C6NHOcsWjxbfE2UUfSZpqCCy1HsMOvjywQOXQs+KQZ4J6vSdNBd5C93kDAZN3EEn+WU3RH6x4QrhPLeh",
	"eNQeXE6wOACwwYzp8BRNYPSKkfeleRyV2DrLhawKyAb5SGOzA9xyofBGan7q5nihhSKbGq6N9nMulatV",
	"PzzwLc/2H2xeNZ77M9MgIUauXIzjwj9P9P3q+oaEcAO4SNaCbEYLHsBaf72vl61td/obza4NH8iJ0Qi0",
	"6eAplDeU4D2C8ehtl3201DIUMGbevzDSkJFA2yu59JAymJ/2+uLjrLlBTIbIeyrBS2aGK29g7IMY3vDD",
	"bPazXGTNyOe8wJqXT1zdsgpx82o+q3u3J0kVRNw8TpNq3kQXwd20M+XUptcG3UBQwnhiKnzmXMdlIQcv",
	"J6ecmSM1wH0fgZ7AOhdquBuw93VCikoSIeFDgcUlokqinK5Juk9z0kwRnu/Hec6vSGY8SF37LZYI54Lg",
	"bI82nBGk7+nVZltXkERVpUlHOY0WbSB2nBafmgpzoMVldzTzaiHiAtlpNJp+GNslMrSD1x/jADitinsP",
	"MeGVMtGtjWnYy/JRV7MJ8kwthiO1GFcJZ9ZoveLZPrkiK0kV8Su5JCuV1HU9ak7cy5sueD5J03cJ3mDK",
	"pKp9iRIuEqcgjNUtBdlRXsmO4b2um1MtzFs4wVlJQ57ynX2os64oib7n5wkjG6zojsh6iIYp1pUriNNJ",
	"FE+ck3dCswRCHGSrU8XLBB4MDSTE/5gMyS2RR3CfAj/q7xK3SyOMyM1tiXCJhUJrwQtEC6PH9hweHIkv",
	"4TJtW9lncW0oVmsoWcmSMMPP3Xfd0nLFwBObtvV9sDMPQuC5jZlHeQUp6sOjmRoS5CTFeVrlMJDkxrdF",
	"lkRIzlCKGTJPrSKMUi4gYEXzWSDr+wcxVrcH45zV1vjzmP80jnlJagBtRIpJv66P/DxHjLP6cV3UPMXg",
	"UkwfLCV2XhtugnFGLqmOrH72m83q2F7TXBGBjA/CaY0rtNrXxtPQ8e2+zYGm/dc9InTdmx5kIgZeOtNr",
	"9ASIj9STzp8me3OfQokzu+wHsRwgBesD15vy2dMWe7tTZcDIhqpz7o1DPaNN1YO1cUDs43rgWAAf+UHW",
	"DzXuyAhkoDnEBmShm6MFqEZcjX4zvRG2Zirdks7OInjI+OOPf0faukGonOmnpo35WX4cynoL3d5mU80+",
	"rrvhM8xEt3x6Int0sfs2n9ktec/kE1355QhD/fyWt23tmd3Sto09A+saNfXMY13v9NCoQjibxcFRzZrY",
	"woibcnycmlwiQ/adfP+5shj7/OycV96khzhy7UGhHV97eAXmc117wE1/7UH1J8haELklmffcx4xoAkAf",
	"ArwBexmy4Pl51iFDgmprk4dIqo7aDpPU/+jPnytJAW5mzU0AwmO5ibTRQeGVf0U37A8r0rQyGYR0QnXO",
	"AL0LDZb5urdF/ceD5iD1rIlKtwCySZw8APCcjB90w+KQTuF4LhP8MNvzXymIXc6etlb0tvVdrUepJmq8",
	"ZrmETufVek3LrkM9yWG911PfqeEWFNgDu71W5GRtGO5mO49BZvVfmUcrs9OAeYgLLHt3A07Ug3kUMXj+",
	"1Pb5T070GFr6njZsjgTQ1YcN08FylO1+nkvd0ozNcZlburGxNY7px2a0xnd8vFRh7M3kiKlmTnwx9A0c",
	"NKSOz4+KG892tydrmL5jgoYJJDf5IO6UCgbB0sjfzVG8MOha7ZHneuitvplUs/SUrfkpthGZQVZ0xtYc",
	"QjZvZ/Hr7iN7TcNmvF+cT9ISgfuXvgadUIYKvKEpZCG9cy+JaXCDC6XxU5kZmzgMt46E6pl3qCjF6ZYM",
	"iam6oTXZQtXbvPPDAANiIgBrXqWcn3zoAddGu5lWVDLUVb4n6uNhV0tm88SsFskmoDXKAc8rD623YDOM",
	"YVRv0wZuL9voHerPpsE2N+Y2utpt5pVjWpx4bwFHKeE7XdO9BPxxzkQAFllg2wwcnJxzssGpCXGyDL3l",
	"Kz3TExNmRbL2vJrDszuz2dHbB1yU0aN2JB2F78I5cn0Ef1p0SfZXXEAarM4zmCGn287jjg1uR317yXuc",
	"KtR+ARMVWKXbsaHqZKXTBzPp7okXAaCR9zgyUl0rNEiTreriLhTdLRfcabru1kPbszK5afryoTN7miqJ",
	"fJS3OHTP79ZQfe18G2fOH8cbFKZlrSwQ5qUqwRBmiOR0Q83jAzYpIfriydn5vRm5/RTzO74PRie62tJ0",
	"CzFjK6JZLDx/4R4dR+YNxKihyxCXe9F9kKd6z74fxFRzziXJ94bV6etH01GIF/06yOjuhAXVU53Kf9yT",
	"CzNlQD54hgPBmiCH+Rb/cXPv0Mhma/VjUf7zPdS4PanQ9B/jQAAfKnhGvG1jZo4UvyR3H0cyAV6SDUI8",
	"N7Y0imNngHfvQOlq/x3UxTUI6tDZluDcaOSinOhvpsptqj9jWNK73WQWRAbQmW75FowdtFv0dfBOy0Gc",
	"w8MUt7pdzs7jAe/AUNDZ+e5rhJus9PNCeQhKxAVa4zyHx6MUR5KIHRH2lQ9vSc7Ou8thbkwn7rnCQcb7",
	"I9R1TzveIgfuDBTAlEMCNsEu7t1IeGKufpprQ3eEoQwr7F8O65cZ1zm/unNmPT41cKq56bRugWqnQT9C",
	"wsesW3fBfIKuQemQdYml1HLhID2fu0ofR8PkYAxaB+qPgkii/jTAHK8zOhrNYwoiI9UOEdj/WLn3tqjL",
	"9B+T/Mxx4d/tcL5XNJV3TkLjcFLzumEP0rlJplGcHiaRGoR06EkSKd2LMzGKemXr3B5NuRFGD10LrhHI",
	"TdoEw7hTnpE7J7FxsEk2CfAZUdwgvrlAlSSIsvoUncCyIGsXVuSkTosfFcR/tlWfuUcBhnQxrl/zFqnB",
	"5s0ySvTT9d9xuhM7f8qZwUDMRw5sD7u68uzuafXSGEgDtrpmpj1ygXR+gwzpZ1Pl40hQNt1g6GD/FIxx",
	"PvjzlZ+OQvIAI3rHV0PRDj/w1d0EOvzAV4fEOLzTcM0wvOGdwZdDuJ7VcFDDD6Cov43tChgdCGV4V498",
	"N/tvAB4bwPDO0MDsYhfaxhSzpt7+OcV5flriPa+UHHApNRXMeg8e37y0rzu+4yt4bMI8dJcTrA9bVGKh",
	"aFrlWCA3aPhYf8dXiX2rop9jFJ5hx3DbhicvbyPb5aSNbx5Uu26/Z2ZfRZjADGq/X73zDN92j/+bN+2Q",
	"vkkqjkpMs08hb2+eu2WFZX/HV6H4NvcoVJPAsH4vHDMw/7npU6kRQiG2WX8yv8FK2AqG65P1tBicCQSt",
	"ofnkwjEi7KoXdDMzptWNtwnxruXQcf85LWaXgcw2oia8irE4mo++incnzFQ9JH18gaaaL1EF8DXM/ycl",
	"k/kD0pvzh/gJJiBDqNZTMrlajMCmJY3coH7VeF8srj8+WzNikZZkS7yfW/BW7aZihCA/9U0Neo1Yi+mQ",
	"RNQWeSRhaoJ4M/k1jB/46hVWLzhky/9sz0e7GnTDrDBZS5/mA1ZUrnFqHunXuJq/vG0n4x4FyLxpdmcT",
	"orpa6tY01+Dlg8nfp1ikWzpIoKbCZya5WbTMVw63AB542k5J3/UHXmnjp/pKYUUmJfDS8/Qzvcw4ZVcX",
	"1NgRdiB7cNamHykboBuNWr/iH5F8nO/Jm5c/ykln2YYwjSPN/FuOL8D852Z89E8vIBzF6wkgbKgrMotx",
	"GjKxB2f25dk4CXn1/qgMyJviFBqaawhKV3nQBnQSRTidX+QksjU+M7GjERNr7LrMYnMTQByoYUjHb1DB",
	"jGkReuE7IgTNBujlJ1vjj6macrOLqQkcfjTXXhHkktAq7ohmHhe7T9JwUuMW+wSsb1pK0M2GCASvuVnU",
	"S8IU+oKukYV7lZN7A6KYW6k1FzV2mj+z+1M2R4n3g1bBP+CWODdqJqM8i20Kq4uyOp0/9WQH6MlK3NaS",
	"LdEoO1+RPWfZZL2YMUGOWbM/c3PRH8HcbI3Nc7A1nwoyYm14aSr8SXaWTUmScpZhsUc5x2zuXMsub1C/",
	"r+eB4HnQERW/dyhrCisF1SPVm5B5bzpOIzlJWDZEcfr7nAhuPu7Q4HR4mH5zGNmvZobqO9jbII/OVYd9",
	"zALTDXOGssHE8cagRj6+Re0WUsfb+Yf0Bx47hKTmU+xO8xGNrYVr1na+o1A8rg65iVxTsVEr3htX5TPj",
	"fzVqfI1aLgjO9qj+MjO2WMM8AvIoXewouRpllj9TcvWn90GzdzXSPiUepOH9eDyoINHojue3mjDzSaW2",
	"byBnXXhhi3kmzCx6+RPriQzHcTwntxh19ZxEIzmKj5gmc2iNbVjHDJfZR1t0nSOetR9jlasZL/I8k6n5",
	"YAUX2HFHpzAZCICzquy7CYI7bxQ4UwPhSgffDIPhygZ3bhHcDIeZqat1q9aJweC4sgXB3ey0EbhskNwM",
	"lXwBrPXXu7PnJkYXNZQwKPY6W9InJ/oOrHkv0miGK9+NNhoigOUYj/0cF7l1x5nhArcciYZXNyYzzWZ1",
	"7/YkqYKIm8dpUs2b6CK4m3amnP5mLszXcZXKcywu50CVvfTd9qpvn+Zcc2EyuDQoCEBg2gxC4WK+KwZW",
	"aT1l+98+4SyxygnIODJrxogKLC5JhrBLamPnPjOvO8zAPVcD259CB/agvd3NlqgtB0VPiuW2peTpbwGB",
	"FRm6x7zEitzNJealdcSfeoMRANl8XSXcbUZYDLo1gHkO32Ogyu0cPS8jMRK1LC6ase/mwBmCyN5dBJ51",
	"TFgXd52V9rfaxOuLJYDBIwZc+D+9cIvIavduLTNf8+4NJrz0y0G++nmtcOtknvnqtq4vsaWNXVxmsLR3",
	"eG5UfUzN4OyoPh1aC2EwdoJUjA28u/HSfB4jPahlX7+0eZ6C2R13oatn6H4gSEFZBiNveSXJJSGlJsaL",
	"CVcXC43C8nLoHSX9fRIs2Wr3VbLlibesiTOrJsZqmnjwhqpLrBLGFUkkYWq0Mt2wJOOpDFWkjCqK82TN",
	"tZyeVKX7psr4t0oSkbjHnCRRVdnrGqqYjH6JexkoiaxCAvF9iSBrIgTOE/K+pIDZQKWc6A4SIMLpV7rg",
	"gm6xRCtCPDeaWeVkNUDCTVlTnqN1t+9ea3Jr9p2sVl7n8cvSK6/e3Vya/BEPuTzJFqQztAHJDirdyrQm",
	"PHyLalW9JZe9FvoHblWyD8vdnJBTILS3LNmhpdmZiTpIjJBEaNNOvHZ1KGbwGPW7//SE9DGy6F3H5koc",
	"3XvYNBpZTmLhnzcJtO5rc13+1kVt6trHLm4zXPuPcGRVcYzO6NiqPgHiHELloYfXaUlYpgkjHlppKvzJ",
	"wD4pBmaX9Vg6uSKrLeeXp7+5YMvr6P3k3NaAjD5/N+1GzZguhNO/mrfJw1WZdDvf8BSLLCdSi/S8YHSx",
	"XBBFL/FiucB5TqtisQTiAa0E3HDXR99Ea+AtkurUFLNafwekyft0Va+LW3i3UgN3HdvFn2s6tzUdWk1o",
	"QtJKULWHVfqWYEEEPLPw6O2FRod5/8+sYSXyxaPFVqlSPjo93Var+6BGvJ/y+9Xl4noZqHHyKx6o9Oj0",
	"NOcpzrdcqkffPPjmweL64vr/BQAA///G6RP2G2oBAA==",
}

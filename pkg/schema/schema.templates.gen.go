...
var TMap = map[TName]string{
  ...
  "body": [
    ...
    },
    {
      ...
      "rows": [
        {
          "text": "Youâ€™ve signed the satisfaction note and will now receive a welcome call from the lender Propensio. Your tradesperson may not get paid on time if you donâ€™t."
        }
      ]
    },
    {
  ...
  "body": [
    ...
    },
    {
      ...
      "rows": [
        {
          "text": "{{sender.contact_name}} has signed the satisfaction note and now needs to complete their welcome call with the lender. Once completed youâ€™ll be paid within 48 hours. Weâ€™ve told them to look out for a call today."
        }
      ]
    },
    {
  ...
  "body": [
    ...
    },
    {
      ...
      "rows": [
        {
          "text": "Great news, the welcome call has been completed and payment is on itâ€™s way to your bank account. This will land within 48-72 hours."
        }
      ]
    },
    {
  ...
  "body": [
    ...
    },
    {
      ...
      "rows": [
        {
          "text": "<b>{{sender.contact_name}}</b> uses Kanda to grow their business by offering their clients financing options. They want to help you grow your business, so they've sent you Â£50-off your yearly subscription to Kanda."
        },
        {
